...
class StripTagsViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	 ...
	 * @param string $allowable_tags <p><a> Sie können den optionalen zweiten Parameter verwenden, um die Tags anzugeben, die nicht entfernt werden sollen.
	 * @return mixed
	 * @see http://www.php.net/manual/function.strip-tags.php
	 * @api
	 */
	public function render($value = NULL, $allowable_tags = NULL) {
		if ($value === NULL) {
		...
		return trim(strip_tags($value,$allowable_tags));
	}
}
